...
class Vehicle():
    def __init__(self, name:str, MacAddr:str, TelemetryPub:TelemetryPublisher, heartbeat:Thread):
        self.name = name
        self.MacAddr = MacAddr
        self.TelemetryPub = TelemetryPub
    ...
    def set_last_beat_time(self, time:timestamp):
